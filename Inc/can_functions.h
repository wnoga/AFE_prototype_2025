...
void CANCircularBuffer_enqueueMessage_data (CANCircularBuffer_t *cb, CAN_Message_t *tmp, uint8_t msg_index, uint8_t total_msg_count, uint8_t channel, void *value, uint8_t size);
...
void CANCircularBuffer_enqueueMessage_timestamp_ms (CANCircularBuffer_t *cb, CAN_Message_t *tmp, uint8_t msg_index, uint8_t total_msg_count, uint32_t timestamp_ms);
